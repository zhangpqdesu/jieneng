	...
	<view class="out">
		...
		<view class="box">
			<view class="return">
			    ...
			    <view v-else class="text">手机号</view>
				<image src="/static/叉号.png" mode="aspectFit" class="image" @click="prompt"></image>
			</view>
			...
			<view v-else class="border">
				<input class="block" type="input" placeholder="请输入手机号" v-model="message.phone">
			</view>
			...
			<view v-else class="border">
				<input class="block" type="input" placeholder="请输入验证码" v-model="message.verification">
					<text class="verification">获取验证码</text>
				</input>
			</view>
		...
		<!-- 图片 -->
		<image src="/static/首页1.png" mode="aspectFit" class="image1"></image>
		<image src="/static/首页2.png" mode="aspectFit" class="image2"></image>
