	...
	<view class="out">
		...
		<view class="box">
			<u-form :model="form" ref="uForm">
				<u-form-item label="昵称" label-position="top" border-bottom="true"><u-input v-model="form.name" placeholder="请输入姓名" /></u-form-item>
				<u-form-item label="权限" label-position="top" border-bottom="true">
